...
import com.genesys.internal.authentication.model.ApiRequestAuthSchemeLookupData;
import com.genesys.internal.authentication.model.ApiRequestChangePasswordOperation;
...
public class AuthenticationApi {
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call changePasswordCall(ApiRequestChangePasswordOperation request, String authorization, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call changePasswordValidateBeforeCall(ApiRequestChangePasswordOperation request, String authorization, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ModelApiResponse changePassword(ApiRequestChangePasswordOperation request, String authorization) throws ApiException {
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<ModelApiResponse> changePasswordWithHttpInfo(ApiRequestChangePasswordOperation request, String authorization) throws ApiException {
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call changePasswordAsync(ApiRequestChangePasswordOperation request, String authorization, final ApiCallback<ModelApiResponse> callback) throws ApiException {
    ...
    /**
     * Build call for retrievePCTokenUsingPOST
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call retrievePCTokenUsingPOSTCall(final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;

        // create path and map variables
        String localVarPath = "/pctoken";
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call retrievePCTokenUsingPOSTValidateBeforeCall(final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        

        com.squareup.okhttp.Call call = retrievePCTokenUsingPOSTCall(progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public Object retrievePCTokenUsingPOST() throws ApiException {
        ApiResponse<Object> resp = retrievePCTokenUsingPOSTWithHttpInfo();
        return resp.getData();
    }
    ...
    /**
     * Retrieve PC token (asynchronously)
     * Returns PC token
     * @param callback The callback to be executed when the API call finishes
     * @return The request call
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call retrievePCTokenUsingPOSTAsync(final ApiCallback<Object> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = retrievePCTokenUsingPOSTValidateBeforeCall(progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<Object>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call retrieveTokenCall(String grantType, String accept, String authorization, String clientId, String password, String refreshToken, String scope, String username, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
    ...
    private com.squareup.okhttp.Call retrieveTokenValidateBeforeCall(String grantType, String accept, String authorization, String clientId, String password, String refreshToken, String scope, String username, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        com.squareup.okhttp.Call call = retrieveTokenCall(grantType, accept, authorization, clientId, password, refreshToken, scope, username, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<DefaultOAuth2AccessToken> retrieveTokenWithHttpInfo(String grantType, String accept, String authorization, String clientId, String password, String refreshToken, String scope, String username) throws ApiException {
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call retrieveTokenAsync(String grantType, String accept, String authorization, String clientId, String password, String refreshToken, String scope, String username, final ApiCallback<DefaultOAuth2AccessToken> callback) throws ApiException {
     ...
     * @param lookupData Data for scheme lookup. (required)
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call tenantInfoCall(ApiRequestAuthSchemeLookupData lookupData, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call tenantInfoValidateBeforeCall(ApiRequestAuthSchemeLookupData lookupData, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        
        // verify the required parameter 'lookupData' is set
        if (lookupData == null) {
            throw new ApiException("Missing the required parameter 'lookupData' when calling tenantInfo(Async)");
        }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ModelApiResponse tenantInfo(ApiRequestAuthSchemeLookupData lookupData) throws ApiException {
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<ModelApiResponse> tenantInfoWithHttpInfo(ApiRequestAuthSchemeLookupData lookupData) throws ApiException {
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call tenantInfoAsync(ApiRequestAuthSchemeLookupData lookupData, final ApiCallback<ModelApiResponse> callback) throws ApiException {
