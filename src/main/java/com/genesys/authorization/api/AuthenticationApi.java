...
public class AuthenticationApi {
    ...
    private com.squareup.okhttp.Call authorizeCall(String responseType, String clientId, String redirectUri, String authorization, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        String localVarPath = "/auth/v3/oauth/authorize".replaceAll("\\{format\\}","json");
    ...
    private com.squareup.okhttp.Call changePasswordCall(ChangePasswordOperation request, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = request;
        
        // create path and map variables
        String localVarPath = "/auth/v3/change-password".replaceAll("\\{format\\}","json");
    ...
    private com.squareup.okhttp.Call getInfoCall(String authorization, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
        
        // create path and map variables
        String localVarPath = "/auth/v3/userinfo".replaceAll("\\{format\\}","json");
    ...
    private com.squareup.okhttp.Call retrieveTokenCall(String grantType, String scope, String authorization, String accept, String clientId, String username, String password, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
        
        // create path and map variables
        String localVarPath = "/auth/v3/oauth/token".replaceAll("\\{format\\}","json");
    ...
    /* Build call for showlogoutUsingGET */
    private com.squareup.okhttp.Call showlogoutUsingGETCall(final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
        
        // create path and map variables
        String localVarPath = "/auth/v3/signed-out".replaceAll("\\{format\\}","json");
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call showlogoutUsingGETValidateBeforeCall(final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        
        
        com.squareup.okhttp.Call call = showlogoutUsingGETCall(progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public Object showlogoutUsingGET() throws ApiException {
        ApiResponse<Object> resp = showlogoutUsingGETWithHttpInfo();
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<Object> showlogoutUsingGETWithHttpInfo() throws ApiException {
        com.squareup.okhttp.Call call = showlogoutUsingGETValidateBeforeCall(null, null);
        Type localVarReturnType = new TypeToken<Object>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }

    /**
     * showlogout (asynchronously)
     * 
     * @param callback The callback to be executed when the API call finishes
     * @return The request call
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call showlogoutUsingGETAsync(final ApiCallback<Object> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = showlogoutUsingGETValidateBeforeCall(progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<Object>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
    /* Build call for signOut */
    private com.squareup.okhttp.Call signOutCall(String authorization, Boolean global, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
        
        // create path and map variables
        String localVarPath = "/auth/v3/sign-out".replaceAll("\\{format\\}","json");
    ...
    private com.squareup.okhttp.Call tenantInfoCall(AuthSchemeLookupOperation lookupOperation, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = lookupOperation;
        
        // create path and map variables
        String localVarPath = "/auth/v3/auth-scheme".replaceAll("\\{format\\}","json");
