...
import com.genesys.authorization.model.UserRole;
...
public class CloudUserDetails {
   ...
   * @return username
  **/
  @ApiModelProperty(example = "null", required = true, value = "System-wide-unique name of user in the system. For contact-center user it includes CME userName , dbid in CME and cc id. For Non-cme users, this can have other formats")
  ...
  **/
  @ApiModelProperty(example = "null", value = "Id of genesys environment user belongs to (if any)")
   ...
   * @return loginName
  **/
  @ApiModelProperty(example = "null", value = "The user name in CME. Not set for users which are not in CME (applications, cloud system admin,...)")
   ...
   * @return dbid
  **/
  @ApiModelProperty(example = "null", value = "DBID of user record in corresponding CME (present iff user belongs to contact center)")
  ...
  **/
  @ApiModelProperty(example = "null", value = "Id of contact center user belongs to (if any)")
  ...
  **/
   ...
   * @return authorities
  **/
  @ApiModelProperty(example = "null", required = true, value = "Authorities assigned to user")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.username, cloudUserDetails.username) &&
        ...
        Objects.equals(this.authorities, cloudUserDetails.authorities);
  }

  @Override
  public int hashCode() {
    return Objects.hash(username, environmentId, loginName, dbid, contactCenterId, cmeUserName, authorities);
  }
